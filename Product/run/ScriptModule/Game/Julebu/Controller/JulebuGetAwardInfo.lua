...
function execute(packetID, operateID, buffer)
	...
	if sqlData == nil or #sqlData == 0 then
		...
		local ret = HttpPost( "http://quniun.com/index.php/"..g_gamename.."/client/makecode", "userid="..cgmsg.userid.."&julebuid="..cgmsg.julebuid )
	end
	gcmsg.qrcodeurl = "http://quniun.com/Uploads/"..g_gamename.."/julebu/"..cgmsg.julebuid.."_"..cgmsg.userid..".jpg"
