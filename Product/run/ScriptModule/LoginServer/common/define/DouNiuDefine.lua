...
--金币场
g_douNiuPour_fenshu[g_douNiuPour_type.pour_5] = {5,10,15,20,25}
...
g_douNiuTime.pour_time = 4      	--下注的时间(也下面的等待下注时间，修改时一同修改)
g_douNiuTime.showpoket_time = 10	--发牌 看牌的时间(也下面的发牌与等待亮牌，修改时一同修改)
g_douNiuTime.dissolve_time = 60 --120 	--申请解散的时候，最长的解散时间
g_douNiuTime.user_play = 15

g_douNiuTime.ready_time = 1800 --1800
g_douNiuTime.banker_time = 5 		--抢庄时间
g_douNiuTime.wait_time =  5      		--等待下注时间
g_douNiuTime.play_time =  2      		--发牌与等待亮牌
g_douNiuTime.next_time =  5		--等待下一局时间

g_douNiuTime.count_time = 6		--结算时间


g_douNiuDefine.max_user = 5		--最大人数
...
g_douNiuCard_type.hulu_niu = 11		--葫芦牛
g_douNiuCard_type.zha_dan = 12   	--炸弹
g_douNiuCard_type.wu_hua = 13  		--五花牛
g_douNiuCard_type.wu_xiao = 14   	--五小牛

--牌点赔率
g_douNiuRate_type = {}
g_douNiuRate_type[0] = 1
g_douNiuRate_type[1] = 1
g_douNiuRate_type[2] = 1
g_douNiuRate_type[3] = 1
g_douNiuRate_type[4] = 1
g_douNiuRate_type[5] = 1
g_douNiuRate_type[6] = 1	--无牛到牛六 一倍
g_douNiuRate_type[7] = 2 	--牛七 二倍
g_douNiuRate_type[8] = 2	--牛八 二倍
g_douNiuRate_type[9] = 2	--牛九 二倍
g_douNiuRate_type[10] = 3	--牛牛 三倍
g_douNiuRate_type[11] = 4	--葫芦牛
g_douNiuRate_type[12] = 5	--炸弹
g_douNiuRate_type[13] = 6	--五花牛
g_douNiuRate_type[14] = 8	--五小牛
...
g_douniuPlayStatus.status_next = 105    --每一轮结束后，点击准备，进入到这个状态
...
g_douNiuDefine.grade_jbc = {}           --
g_douNiuDefine.grade_jbc['free'] = 1
g_douNiuDefine.grade_jbc['junior'] = 2
g_douNiuDefine.grade_jbc['medium'] = 3
g_douNiuDefine.grade_jbc['serior'] = 4

g_douNiuDefine.table_type = {1,2,3,4}
g_douNiuDefine.pourList = {}
g_douNiuDefine.pourList[1] = 20
g_douNiuDefine.pourList[2] = 100
g_douNiuDefine.pourList[3] = 500
g_douNiuDefine.pourList[4] = 1000

g_douNiuDefine.max_qiang = 4    --最大的抢庄倍数是4倍


--进入金币车的最低分数
g_douNiuDefine.minJettonJBC = {}
g_douNiuDefine.minJettonJBC[1] = 1000
g_douNiuDefine.minJettonJBC[2] = 5000
g_douNiuDefine.minJettonJBC[3] = 25000
g_douNiuDefine.minJettonJBC[4] = 50000


g_douNiuDefine.MaxJettonJBC = {}
g_douNiuDefine.MaxJettonJBC[1] = -1
g_douNiuDefine.MaxJettonJBC[2] = -1
g_douNiuDefine.MaxJettonJBC[3] = -1
g_douNiuDefine.MaxJettonJBC[4] = -1

--机器人进入房间的金币区间
g_douNiuDefine.RobotJettonSection = {}
g_douNiuDefine.RobotJettonSection[1] = {1000, 10000}
g_douNiuDefine.RobotJettonSection[2] = {5000, 40000}
g_douNiuDefine.RobotJettonSection[3] = {25000, 70000}
g_douNiuDefine.RobotJettonSection[4] = {50000, 100000}

--台位费
g_douNiuDefine.GameFee = {}
g_douNiuDefine.GameFee[1] = 100
g_douNiuDefine.GameFee[2] = 300
g_douNiuDefine.GameFee[3] = 2000
g_douNiuDefine.GameFee[4] = 2000

g_douNiuDefine.game_lockstate = {}
g_douNiuDefine.game_lockstate.lock_no = 1
g_douNiuDefine.game_lockstate.lock_yes = 2
