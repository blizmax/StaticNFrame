...
--换桌
PacketCode[3055] = {server = 3055, client = 3056, des = "cgdouniuvarytable", func = "DouNiuVaryTable"}
PacketCode[3056] = {server = 3055, client = 3056, des = "gcdouniuvarytable", func = "DouNiuVaryTable"}
...
ReturnCode["douniu_put_error"] = 3054		 	--拼牛需要有10倍数哦
ReturnCode["douniu_Jetton_overbrim"] = 3055		--您的金币太多了， 请到更高级的场去玩！！！！
...
ReturnCode[3054] = "拼牛需要有10倍数哦"
ReturnCode[3055] = "您的金币太多了， 请到更高级的场去玩！！！！"
