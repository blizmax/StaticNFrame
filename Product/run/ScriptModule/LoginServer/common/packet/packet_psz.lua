...
--换桌
PacketCode[3343] = {server = 3343, client = 3944, des = "cgpszvarytable", func = "PszVaryTable"}
PacketCode[3944] = {server = 3343, client = 3944, des = "gcpszvarytable", func = "PszVaryTable"}
...
ReturnCode["psz_sit_ing"] = 3316 			--您已经在座位上	
...
ReturnCode["psz_game_notover"] = 3335		--请在弃牌或本局游戏结束后再退出游戏			
ReturnCode["psz_jetton_error_1"] = 3336		--金币太多了, 请到更高的场次去玩吧			
...
ReturnCode[3335] = "请在弃牌或本局游戏结束后再退出游戏"
ReturnCode[3336] = "金币太多了, 请到更高的场次去玩吧"	
----------------------