...
PacketCode[2513] = {server = 2513, client = 2514, des = "cgbrnncreatetable", func = "BrnnCreateTable"}
...
PacketCode[2537] = {server = 2537, client = 2538, des = "cgbrnnallgamehistory", func = "BrnnAllGameHistory"}
PacketCode[2538] = {server = 2537, client = 2538, des = "gcbrnnallgamehistory", func = "BrnnAllGameHistory"}

PacketCode[2539] = {server = 2539, client = 2540, des = "cgbrnngamehistoryupdata", func = "BrnnGameHistoryUpdata"}
PacketCode[2540] = {server = 2539, client = 2540, des = "gcbrnngamehistoryupdata", func = "BrnnGameHistoryUpdata"}
--
...
ReturnCode["brnn_is_bankerlist"] = 2520  --已经在上庄列表中，请耐心等候
ReturnCode["brnn_jetton_error_1"] = 2526  --金币不足，无法进人房间
ReturnCode["brnn_jetton_error_2"] = 2527  --金币太多，无法进人房间
ReturnCode["brnn_banker_notenough_2"] = 2528  --筹码不足，不能上庄
...
ReturnCode[2516] = "金币不足，最低上庄需要3000金币"
ReturnCode[2517] = "已达下注上限，下注失败"
ReturnCode[2518] = "你已在本局游戏中下注，请等待游戏结束再离开"
ReturnCode[2519] = "该牌桌人数已满，请选择其他牌桌"
ReturnCode[2520] = "您已经加入上庄列表中，请耐心等着"
ReturnCode[2526] = "金币不足，无法进入房间"
ReturnCode[2527] = "金币太多，无法进入房间"
ReturnCode[2528] = "金币不足，最低上庄需要3000金币"


ReturnCode["brnn_not_banker"] = 2521  
ReturnCode[2521] = "您还不是庄家呢"  

ReturnCode["brnn_is_drop"] = 2522  
ReturnCode[2522] = "您已经申请下庄了"  

ReturnCode["brnn_drop_success"] = 2523  
ReturnCode[2523] = "申请下庄成功"  


ReturnCode["brnn_bebankeer_success"] = 2524  
ReturnCode[2524] = "申请上庄成功"  


ReturnCode["brnn_pour_max"] = 2525  
ReturnCode[2525] = "已经超过下注限额，请选择更小的面值"  
----------------------