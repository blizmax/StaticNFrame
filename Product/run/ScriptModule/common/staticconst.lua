...
--静态常量，旅行团，雇佣CD时间
static_const.Static_Const_TRAVEL_Employ_CD_Time = 600

--静态常量，旅行团，团员跟团时间周期
static_const.Static_Const_TRAVEL_Employ_MAX_TIME = 600

--静态常量，旅行团，旅行团初始化抓捕次数
static_const.Static_Const_TRAVEL_INIT_MAX_CAPTURE_TIMES = 3
