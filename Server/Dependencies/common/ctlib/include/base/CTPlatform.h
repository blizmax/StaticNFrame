...
#ifndef __CTLIB_PLATFORM_H__
#define __CTLIB_PLATFORM_H__
...
/**
* CTPlatform类用来屏蔽Windows和Linux一些基本函数的差异
*/
class CTPlatform
{
public:
    ...
    */
    static CTAutoCharA _ct_wcstombs(const wchar_t* psz)
    {
        CTAutoCharA autop;
