// -------------------------------------------------------------------------
//    @FileName         :    NFCLogClient_MasterModule.h
//    @Author           :    GaoYi
//    @Date             :    2018/06/12
...
#include <NFServer/NFServerCommon/NFILogClient_MasterModule.h>
...
class NFCLogClient_MasterModule : public NFILogClient_MasterModule, public NFEventObj
{
public:
	explicit NFCLogClient_MasterModule(NFIPluginManager* p);

	virtual ~NFCLogClient_MasterModule();
