...
TC_PackIn::TC_PackInInner& TC_PackIn::TC_PackInInner::operator << (const std::string& sBuffer)
{
...
TC_PackOut& TC_PackOut::operator >> (std::string& sBuffer)
{
	uint32_t len = 0;
	unsigned char c;
	(*this) >> c;
