...
bool AFCDataNodeManager::OnNodeCallback(const char* name, const NFIData& oldData, const NFIData& newData)
{
    size_t indexCallBack = 0;
...
bool AFCDataNodeManager::AddNode(const char* name, const NFIData& value, const int8_t feature)
{
...
bool AFCDataNodeManager::SetNode(const char* name, const NFIData& value)
{
    size_t index;
    if(!FindIndex(name, index))
    {
