...
public:
    ...
    virtual bool AddNode(const char* name, const NFIData& value, const int8_t feature);
    virtual bool SetNode(const char* name, const NFIData& value);
...
protected:
    ...
    bool OnNodeCallback(const char* name, const NFIData& oldData, const NFIData& newData);
