...
public:
    ...
    virtual int32_t GetNodeInt32(const std::string& name) = 0;
    virtual uint32_t GetNodeUInt32(const std::string& name) = 0;
    virtual int64_t GetNodeInt64(const std::string& name) = 0;
    virtual uint64_t GetNodeUInt64(const std::string& name) = 0;
    virtual float GetNodeFloat(const std::string& name) = 0;
    virtual double GetNodeDouble(const std::string& name) = 0;
	virtual const std::string& GetNodeString(const std::string& name) = 0;
